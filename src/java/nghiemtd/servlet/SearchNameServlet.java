...
public class SearchNameServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Search Name servlet");

        HttpSession session = request.getSession(false);
        String searchValue = request.getParameter("txtSearchValue");
        String stringPage = request.getParameter("page");
        String lastSearch = (String) session.getAttribute("SEARCH_NAME");
        ...
        try {
            ...
            List<FoodDTO> listFood = dao.searchByName(searchValue, page);
            List<Integer> listPage = MyToys.listPage(dao.countSearchByName(searchValue));

            session.setAttribute("LIST_TYPE", "name");
            session.setAttribute("LIST_FOOD", listFood);
            session.setAttribute("LIST_TYPE", "name");
            session.setAttribute("SEARCH_NAME", searchValue);
