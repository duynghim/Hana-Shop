...
import nghiemtd.tbl_orderDetail.OrderDetailDTO;
...
public class ViewHistoryDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            List<OrderDetailDTO> listOrderDetail = orderDetailDAO.getAllListOrderByOrderID(orderID);

            request.setAttribute("ORDER_DETAIL_LIST", listOrderDetail);
        }catch (Exception e){
            e.printStackTrace();
        }finally {
